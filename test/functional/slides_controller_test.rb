...
class SlidesControllerTest < ActionController::TestCase
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post :create, slide: { position: @slide.position, slide_image: @slide.slide_image, user_id: @slide.user_id }
    end
  ...
  test "should update slide" do
    put :update, id: @slide, slide: { position: @slide.position, slide_image: @slide.slide_image, user_id: @slide.user_id }
    assert_redirected_to slide_path(assigns(:slide))
  end
